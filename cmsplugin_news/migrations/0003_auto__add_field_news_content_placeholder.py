...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.content_placeholder'
        db.add_column('cmsplugin_news_news', 'content_placeholder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.content_placeholder'
        db.delete_column('cmsplugin_news_news', 'content_placeholder_id')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 0, 0)'}),
