...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_news_news', 'content')


    def backwards(self, orm):
        # Adding field 'News.content'
        db.add_column('cmsplugin_news_news', 'content',
    ...
    models = {
        ...
        'cmsplugin_news.news': {
            ...
            'content_placeholder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Placeholder']", 'null': 'True', 'blank': 'True'}),
